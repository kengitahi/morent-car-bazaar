        ...
        <form action="" class="grid grid-cols-1 lg:grid-cols-[1fr_1fr_60px] gap-5 content-center">
            <div class="pickup w-100">
                ...
                <div class=" flex gap-2 w-full justify-between items-center">
                    ...
                    <x-datetime-picker id="pickup-date" wire:model="pickup-date" label="Date"
                        placeholder="Select Pickup Date" :min="now()" :max="now()->addDays(21)" />
                    <x-time-picker id="pickup-time" wire:model.defer="pickup-time" label="Time"
            ...
            <div class="dropoff">
                ...
                <div class="flex gap-2">
                    <x-select label="Location" placeholder="Select Dropoff City" wire:model="pickup-location"
                        wire:model="dropoff-location" :options="[
                        ['city' => 'London', 'id' => 1],
                        ['city' => 'Amsterdam', 'id' => 2],
                        ['city' => 'Nairobi', 'id' => 3],
                        ['city' => 'Mombasa', 'id' => 4],
                    ]" option-label="city" option-value="id" />
                    <x-datetime-picker id="dropoff-date" label="Date" wire:model="dropoff-date"
                        placeholder="Select Drop off Date" :min="now()->addDays(1)" :max="now()->addDays(21)" />
                    <x-time-picker id="dropoff-time" wire:model.defer="dropoff-time" label="Time"
                        placeholder="12:00 AM" />
                </div>
            </div>
