    ...
    <div>
        <div class="grid grid-cols-2 gap-8">
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between">
                    <div class="space-y-2">
                        <h2 class="text-secondary-500 font-bold text-3xl">{{$singleCar->name}}</h2>
                        <h3 class="text-secondary-400 text-sm font-medium">{{$singleCar->rating}}/5</h3>
                    </div>
                ...
                <p class="text-lg text-secondary-400 leading-normal">{{$singleCar->short_description}}</p>
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-1 lg:gap-2">
                    <div class="flex gap-1 items-center">
                        ...
                        <p class="text-secondary-400 text-sm capitalize">Car Type: {{$singleCar->type}}</p>
                    </div>
                    <div class="flex gap-1 items-center">
                        <div class="text-secondary-400">
                        ...
                        <p class="text-secondary-400 text-sm">{{$singleCar->fuel=="gasoline"?'Tank Capacity':'Range'}} {{$singleCar->fuel_capacity}} {{$singleCar->fuel=="gasoline"?'L':'Kms'}}</p>
                    </div>
                    <div class="flex gap-1 items-center">
                        <div class="text-secondary-400">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="24">
                        ...
                        <p class="capitalize text-secondary-400 text-sm">Steering: {{$singleCar->steering}}</p>
                    </div>
                    <div class="flex gap-1 items-center">
                        <div class="text-secondary-400">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="24">
                        ...
                        <p class="text-secondary-400 text-sm">Capacity: {{$singleCar->capacity}} people</p>
                    </div>
                </div>
                <div class="flex justify-between">
                    <div class="flex flex-col gap-0.5">
                        <p>
                            <span class="text-secondary-500 font-bold text-base">${{$singleCar->regular_price}}/</span><span class="text-secondary-400 text-sm">day</span>
                        </p>
                        <p class="text-secondary-400 text-sm line-through">${{$singleCar->discounted_price}}</p>
        ...
        <div>
            <div class="flex flex-cols justify-between items-center">
                <h2 class="text-xl font-bold my-4 text-secondary-900">Recent Cars</h2>
        ...
        <div>
            <h2 class="text-xl font-bold my-4 text-secondary-900">Recommended Cars</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
