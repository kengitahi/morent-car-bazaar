<div class="mb-8 sm:mb-4 p-4 shadow-2xl rounded-lg">
    <header class="flex flex-cols justify-between items-center gap-4 mb-2">
        <div class="space-y-1">
            <h2 class="text-secondary-500 font-bold text-lg">
    ...
    <main class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-1 lg:gap-2">
            ...
            <div class="flex gap-1 items-center">
                ...
                <p class="text-secondary-400 text-sm">{{$car['fuel']=="gasoline"? $car['fuel_capacity'] . ' L'
                    :$car['range']
                    . ' Kms'}}</p>
        ...
        <div class="flex justify-between">
            <div class="flex flex-col gap-0.5">
                <p>
                    <span class="text-secondary-500 font-bold text-base">${{$car['regular_price']}}/</span><span
                        class="text-secondary-400 text-sm">day</span>
                </p>
                <p class="text-secondary-400 text-sm line-through">${{$car['discounted_price']}}</p>

            </div>
            <a href="{{route('car.show', $car['id'])}}"
                class="inline-flex items-center px-3 py-2 text-base font-medium text-center text-white bg-blue-700 rounded hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                See car
